...
this time we created a craete-raect-app  by terminal npx create-react-app <project_name>
installed tailwind of craete-raect-app in the app
there were some error inthe pastr few days for not upgrading the craete-raect-app solved it by following steps 
If you're using an old version of CRA, try upgrading:
npx create-react-app@latest <projrct-namee>
...
for authentication we use google firebase as backend
features of  firebase=> hosting
build folder=>
=======
>>>>>>> parent of a0d5bd4 (form validation)
